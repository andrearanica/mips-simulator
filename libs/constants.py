...
SPECIAL_ADDRESSES = {
    'RECEIVER_CONTROL_ADDRESS': RECEIVER_CONTROL_ADDRESS,
    'RECEIVER_DATA_ADDRESS': RECEIVER_DATA_ADDRESS,
    'TRANSMITTER_CONTROL_ADDRESS': TRANSMITTER_CONTROL_ADDRESS,
    'TRANSMITTER_DATA_ADDRESS': TRANSMITTER_DATA_ADDRESS
}